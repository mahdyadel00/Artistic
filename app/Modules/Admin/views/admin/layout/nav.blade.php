<nav class="pcoded-navbar" pcoded-header-position="relative">
    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            @can('Login')
                <li class=" {{ request()->is('admin/login/*') || request()->is('admin/login') ? 'active' : '' }}">
            ...
            @endcan
            @can('mainPage')
                <li class=" {{ request()->is('admin/main_page/*') || request()->is('admin/main_page') ? 'active' : '' }}">
            ...
            @endcan
            @can('Help')
                <li class=" {{ request()->is('admin/help/*') || request()->is('admin/help') ? 'active' : '' }}">
            ...
            @can('Question Details')
                <li
                    class=" {{ request()->is('admin/question_details/*') || request()->is('admin/question_details') ? 'active' : '' }}">
            ...
            @can('Question MCQ')
                <li
                    class=" {{ request()->is('admin/question_select/*') || request()->is('admin/question_select') ? 'active' : '' }}">
