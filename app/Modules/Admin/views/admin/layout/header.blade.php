<nav class="navbar header-navbar pcoded-header" header-theme="theme4">
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            ...
            <a href="{{ url('/') }}">
                <img class="img-fluid img-responsive" style="width: 160px;height: 50px"
                    src="{{ asset('site') }}/img/logo.png" alt="Logo" />
            </a>
            ...
            <div>
                ...
                <ul class="nav-right">
                    <li class="header-notification lng-dropdown">
                        ...
                        $languages = App\Models\Language::where('code', '!=', LaravelGettext::getLocale())->get();
                        ?>
                        ...
                        <ul class="show-notification">
                            ...
                            <li>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="notification-user"><a
                                                href='{{ route('notificationAll.index') . '?type=notAll' }}'
